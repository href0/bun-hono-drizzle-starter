...
CREATE TABLE "role_access_menu" (
	"id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "role_access_menu_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	...
	"created_by" integer NOT NULL,
	"updated_by" integer,
	CONSTRAINT "role_access_menu_unique" UNIQUE("role_id","menu_id","method")
);
--> statement-breakpoint
CREATE TABLE "roles" (
...
CREATE TABLE "system_init" (
	"id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "system_init_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"initialized_at" timestamp (3) with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "menus" ADD CONSTRAINT "menus_parent_id_menus_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."menus"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
...
ALTER TABLE "role_access_menu" ADD CONSTRAINT "role_access_menu_role_id_roles_id_fk" FOREIGN KEY ("role_id") REFERENCES "public"."roles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "role_access_menu" ADD CONSTRAINT "role_access_menu_menu_id_menus_id_fk" FOREIGN KEY ("menu_id") REFERENCES "public"."menus"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "role_access_menu" ADD CONSTRAINT "role_access_menu_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "role_access_menu" ADD CONSTRAINT "role_access_menu_updated_by_users_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "api_endpoint_idx" ON "menus" USING btree ("api_endpoint");--> statement-breakpoint
CREATE UNIQUE INDEX "permission_api_idx" ON "permissions" USING btree ("api");--> statement-breakpoint
