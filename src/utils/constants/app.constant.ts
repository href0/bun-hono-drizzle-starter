...
export const ACCESS_TOKEN_EXPIRED = Math.floor(Date.now() / 1000) + 1 * 1 * 60 * 60 // Token expires in 1 hour
export const REFREH_TOKEN_EXPIRED = Math.floor(Date.now() / 1000) + 30 * 24 * 60 * 60 // Token expires in 30 days
