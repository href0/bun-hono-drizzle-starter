// import { menuService } from "../../modules/admin/menu/menu.service";
// import { InsertMenu, ResponseMenu, UpdateMenu } from "../../modules/admin/menu/menu.type";
...
//   public static async create(): Promise<ResponseMenu> {
...
//   public static async update(): Promise<ResponseMenu> {
